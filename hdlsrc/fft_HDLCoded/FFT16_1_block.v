// -------------------------------------------------------------
// 
// File Name: /home/mori/Downloads/tomori_fft/hdlsrc/fft_overlap_tomori/FFT16_1_block.v
...
// -------------------------------------------------------------
// 
// Module: FFT16_1_block
// Source Path: fft_overlap_tomori/FFT64_outMuxed/64pointFFTchan/FFT64/FFT32_1/FFT16_1
// Hierarchy Level: 4
// Model version: 3.27
// 
// -------------------------------------------------------------
...
module FFT16_1_block
  ...
  FFT8_1_block2 u_FFT8_1 (.clk(clk),
                          .reset(reset),
                          .enb_1_64_0(enb_1_64_0),
  ...
  complexmult_block3 u_complexmult (.clk(clk),
                                    .reset(reset),
                                    .enb_1_64_0(enb_1_64_0),
                                    .x1_re(FFT8_1_out2_re),  // sfix22_En15
                                    .x1_im(FFT8_1_out2_im),  // sfix22_En15
  ...
  alpha4_block11 u_multByExp_j_Pi_4 (.clk(clk),
                                     .reset(reset),
                                     .enb_1_64_0(enb_1_64_0),
  ...
  complexmult1_block3 u_complexmult1 (.clk(clk),
                                      .reset(reset),
                                      .enb_1_64_0(enb_1_64_0),
  ...
  multByMinusJ_block11 u_multByMinusJ (.x4_re(FFT8_1_out5_re),  // sfix22_En15
                                       .x4_im(FFT8_1_out5_im),  // sfix22_En15
  ...
  complexmult2_block3 u_complexmult2 (.clk(clk),
                                      .reset(reset),
                                      .enb_1_64_0(enb_1_64_0),
  ...
  alpha4_1_block11 u_multByExp_j_Pi_4_1 (.clk(clk),
                                         .reset(reset),
                                         .enb_1_64_0(enb_1_64_0),
  ...
  multByMinusJ3_block11 u_multByMinusJ3 (.In1_re(multByExp_j_Pi_4_1_out1_re),  // sfix22_En15
  ...
  complexmult3_block3 u_complexmult3 (.clk(clk),
                                      .reset(reset),
                                      .enb_1_64_0(enb_1_64_0),
