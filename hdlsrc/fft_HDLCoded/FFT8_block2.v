// -------------------------------------------------------------
// 
// File Name: /home/mori/Downloads/tomori_fft/hdlsrc/fft_overlap_tomori/FFT8_block2.v
...
// 
// Module: FFT8_block2
// Source Path: fft_overlap_tomori/FFT64_outMuxed/64pointFFTchan/FFT64/FFT32_1/FFT16_1/FFT8
// Hierarchy Level: 5
// Model version: 3.27
// 
// -------------------------------------------------------------
...
module FFT8_block2
  ...
  multByMinusJ_block9 u_multByMinusJ (.In1_re(Add7_out1_re),  // sfix22_En15
  ...
  multByMinusJ1_block5 u_multByMinusJ1 (.In1_re(Add9_out1_re),  // sfix22_En15
  ...
  alpha4_block9 u_multByExp_j_Pi_4 (.clk(clk),
                                    .reset(reset),
  ...
  multByMinusJ2_block5 u_multByMinusJ2 (.In1_re(Delay28_out1_re),  // sfix22_En15
  ...
  alpha4_1_block9 u_multByExp_j_Pi_4_1 (.clk(clk),
                                        .reset(reset),
                                        .enb_1_64_0(enb_1_64_0),
  ...
  multByMinusJ3_block9 u_multByMinusJ3 (.In1_re(multByExp_j_Pi_4_1_out1_re),  // sfix22_En15
