// -------------------------------------------------------------
// 
// File Name: /home/mori/Downloads/tomori_fft/hdlsrc/fft_overlap_tomori/FFT16.v
...
// 
// Module: FFT16
// Source Path: fft_overlap_tomori/FFT64_outMuxed/64pointFFTchan/FFT64/FFT32/FFT16
// Hierarchy Level: 4
// Model version: 3.27
// 
// -------------------------------------------------------------
...
module FFT16
  ...
  complexmult u_complexmult (.clk(clk),
                             .reset(reset),
                             .enb_1_64_0(enb_1_64_0),
                             .x1_re(FFT8_1_out2_re),  // sfix22_En15
                             .x1_im(FFT8_1_out2_im),  // sfix22_En15
  ...
  alpha4_block1 u_multByExp_j_Pi_4 (.clk(clk),
                                    .reset(reset),
                                    .enb_1_64_0(enb_1_64_0),
  ...
  complexmult1 u_complexmult1 (.clk(clk),
                               .reset(reset),
                               .enb_1_64_0(enb_1_64_0),
  ...
  multByMinusJ_block1 u_multByMinusJ (.x4_re(FFT8_1_out5_re),  // sfix22_En15
                                      .x4_im(FFT8_1_out5_im),  // sfix22_En15
  ...
  complexmult2 u_complexmult2 (.clk(clk),
                               .reset(reset),
                               .enb_1_64_0(enb_1_64_0),
  ...
  alpha4_1_block1 u_multByExp_j_Pi_4_1 (.clk(clk),
                                        .reset(reset),
                                        .enb_1_64_0(enb_1_64_0),
  ...
  multByMinusJ3_block1 u_multByMinusJ3 (.In1_re(multByExp_j_Pi_4_1_out1_re),  // sfix22_En15
  ...
  complexmult3 u_complexmult3 (.clk(clk),
                               .reset(reset),
                               .enb_1_64_0(enb_1_64_0),
